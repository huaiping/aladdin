...
CREATE TABLE IF NOT EXISTS `swan_course` (
  ...
  `wl` varchar(6) DEFAULT NULL,
  `hx` varchar(6) DEFAULT NULL,
  `sw` varchar(6) DEFAULT NULL,
  `zz` varchar(6) DEFAULT NULL,
  `ls` varchar(6) DEFAULT NULL,
  `dl` varchar(6) DEFAULT NULL,
  `courses` varchar(18) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `swan_salary` (
  ...
  `xm` varchar(12) NOT NULL,
  `gwgz` decimal(7,2) unsigned NOT NULL,
  `tgjt` decimal(7,2) unsigned NOT NULL,
  `xjgz` decimal(7,2) unsigned NOT NULL,
  `shbt` decimal(7,2) unsigned NOT NULL,
  `bfzsgz` decimal(7,2) unsigned NOT NULL,
  `jyjt` decimal(7,2) unsigned NOT NULL,
  `jxgz70` decimal(7,2) unsigned NOT NULL,
  `jxgz30` decimal(7,2) unsigned NOT NULL,
  `wsf` decimal(6,2) unsigned NOT NULL,
  `gzjs` decimal(7,2) unsigned NOT NULL,
  `yfhj` decimal(7,2) unsigned NOT NULL,
  `sds` decimal(7,2) unsigned NOT NULL,
  `fz` decimal(7,2) unsigned NOT NULL,
  `hf` decimal(7,2) unsigned NOT NULL,
  `sjgz` decimal(7,2) unsigned NOT NULL,
  `zfgjj` decimal(7,2) unsigned NOT NULL,
  `df` decimal(6,2) unsigned NOT NULL,
  `sf` decimal(6,2) unsigned NOT NULL,
  `ylbx` decimal(6,2) unsigned NOT NULL,
  `yb` decimal(6,2) unsigned NOT NULL,
  `dbyb` decimal(7,2) unsigned NOT NULL,
  `kx` decimal(6,2) unsigned NOT NULL,
  `kk` decimal(7,2) unsigned NOT NULL,
  `bkf` decimal(6,2) unsigned NOT NULL,
  `jk` decimal(7,2) unsigned NOT NULL,
  `kjk` decimal(7,2) unsigned NOT NULL,
  `kdf` decimal(6,2) unsigned NOT NULL,
  `hyxf` decimal(7,2) unsigned NOT NULL,
  `kkhj` decimal(7,2) unsigned NOT NULL,
  `zdgz` decimal(7,2) unsigned NOT NULL,
  `txkkhsfs` decimal(7,2) unsigned NOT NULL,
  `bfzz` decimal(7,2) unsigned NOT NULL,
  `syjljxgz` decimal(7,2) unsigned NOT NULL,
  `sypggz` decimal(7,2) unsigned NOT NULL,
  `qmpg` decimal(6,2) unsigned NOT NULL,
  `gkjx` decimal(7,2) unsigned NOT NULL,
  `bukf` decimal(7,2) unsigned NOT NULL,
  `gsdb` decimal(6,2) unsigned NOT NULL,
  `ykbz` decimal(7,2) unsigned NOT NULL,
  `jsj` decimal(7,2) unsigned NOT NULL,
  `cjxqwmdwj` decimal(7,2) unsigned NOT NULL,
  `qjxqwmdwj` decimal(7,2) unsigned NOT NULL,
  `cjxqzzxjj` decimal(7,2) unsigned NOT NULL,
  `qjxqzzxjj` decimal(7,2) unsigned NOT NULL,
  `jsbz` decimal(7,2) unsigned NOT NULL,
  `gbjt` decimal(7,2) unsigned NOT NULL,
  `jkgbjt` decimal(7,2) unsigned NOT NULL,
  `sfshj` decimal(7,2) unsigned NOT NULL,
