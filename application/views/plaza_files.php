		        ...
		        <div class="col-md-9">
					...
					<!--<form class="form-horizontal" name="example" method="post" action="#" autocomplete="off">-->
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-11 col-md-5"><input type="text" class="form-control" id="title" name="title"></div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-11 col-md-11"><input type="file" class="form-control" name="userfile"></div>
						</div>
