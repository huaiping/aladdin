<section class="container">
    ...
    <div class="score row">
        <div class="col-xs-12 col-md-9">
            <!--工资详情 begin-->
            <div class="widget-box no-border">
                <div class="widget-box_title bs-callout bs-callout-info"><h4><?php echo substr($salary['timestamp'], 0, 4).'年'.substr($salary['timestamp'], 4, 2).'月'; ?>工资详情<span class="pull-right fa fa-bars" style="padding-right:10px;"></span></h4></div>
        ...
        <div class="col-md-3 hidden-xs hidden-sm">
            <div class="widget-box no-border">
                <div class="widget-box_title bs-callout bs-callout-danger"><h4>近12个月工资<span class="pull-right fa fa-bars" style="padding-right:10px;"></span></h4></div>
