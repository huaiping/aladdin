            ...
            <div class="col-md-6 hidden-xs hidden-sm">
                ...
                <div class="media" style="margin-top:20px;">
                    ...
                    <div class="media-body">
                        ...
                        <p style="min-height:80px;">选择查询项目，例如：2018年春高二期中考试；姓名栏输入姓名，需与学籍姓名一致；学号栏输入对应的学号、班级号或身份证号。</p>
                    </div>
                </div>
                <!--使用指南 end-->
            </div>
            ...
            <div class="col-md-6 hidden-xs hidden-sm">
                ...
                <div class="media" style="margin-top:40px; margin-bottom:40px;">
                    ...
                    <div class="media-body">
                        ...
                        <p>用身份证号代替学号和班级号，可查询高中阶段历次考试分数和名次详情</p>
                        <p>高校自主招生和高校专项计划需要填写每学期考试成绩和年级排名</p>
                    </div>
                </div>
                <!--历次成绩 end-->
            </div>
            ...
            <div class="col-md-6 hidden-xs hidden-sm">
                ...
                <div class="media" style="margin-top:40px; margin-bottom:40px;">
                    ...
                    <div class="media-body">
                        ...
                        <p>用身份证号代替学号和班级号，可查询高中阶段历次考试的成绩曲线图，学业成长走势一目了然</p>
                    </div>
                </div>
                <!--成绩曲线 end-->
            </div>
