            ...
            <table class="table table-striped table-bordered table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr class="widget-links">
                        <td class="col-xs-12 col-sm-7 col-md-6 widget-links_item"><a href="<?php echo site_url('download/view/'.$down_list[$i]['id']); ?>"><?php echo $down_list[$i]['title']; ?></a></td>
                        <td class="col-sm-2 col-md-2 widget-links_item hidden-xs"><?php echo substr($down_list[$i]['pubtime'],0,10); ?></td>
                        <td class="col-sm-2 col-md-2 widget-links_item hidden-xs">404 K</td>
