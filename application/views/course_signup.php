    ...
    <div class="notice row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible" role="alert">
                <strong><span class="glyphicon glyphicon-fire"></span> 当前已有 <?php echo $numbers; ?> 人成功提交模拟选课报名信息！</strong>
            </div>
        </div>
    </div>

    <div class="row">
        <h1 class="text-center" style="margin-top:0; margin-bottom:20px;">高一选课预报名</h1>
